# DefiLlama API (direct REST — use this, not the DefiLlama MCP)

> DefiLlama provides free, open-source DeFi analytics data. There are two separate
> APIs with different base URLs and authentication. Do NOT mix them.
>
> In this pipeline, query DefiLlama with `curl` against these endpoints (as in
> `references/01-defillama-pr-recon.md`). Do not use the DefiLlama MCP tools.
...
Full documentation: [llms-free.txt](https://api-docs.defillama.com/llms-free.txt)
...
Full documentation: [llms-pro.txt](https://api-docs.defillama.com/llms-pro.txt)
...
- [OpenAPI spec (free)](https://api-docs.defillama.com/defillama-openapi-free.json): Full OpenAPI 3.0 specification for free endpoints
- [OpenAPI spec (pro)](https://api-docs.defillama.com/defillama-openapi-pro.json): Full OpenAPI 3.0 specification for pro endpoints
